...
data_root = 'data/hdmap/av2/sensor/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'full/av2_map_infos_train.pkl',
        z_cfg=z_cfg,
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'full/av2_map_infos_val.pkl',
...
evaluation = dict(interval=1, pipeline=test_pipeline, metric='chamfer',
                  save_best='AV2Map_chamfer/mAP', rule='greater')
# total_epochs = 50
